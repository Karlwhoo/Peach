                    ...
                    {{ Form::open(array('url' => 'room', 'method' => 'POST','class' => 'form-horizantal','files' => true)) }}
                        <div class="card-body pb-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="Type" class="form-label col-md-3">Room Type:</label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="DiningArea" value="1">
                                                <label class="form-check-label">Dining Area</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="Table" value="1">
                                                <label class="form-check-label">Table</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="Chair" value="1">
                                                <label class="form-check-label">Chair</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="WiFi" value="1">
                                                <label class="form-check-label">WiFi</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="Toilet" value="1">
                                                <label class="form-check-label">Toilet</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="Toiletries" value="1">
                                                <label class="form-check-label">Toiletries</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="Bathroom" value="1">
                                                <label class="form-check-label">Bathroom</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="TV" value="1">
                                                <label class="form-check-label">TV Set</label>
                                            </div>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="AC" value="1">
